...
In [Environment variables in EAS](/eas/environment-variables) we described concepts related to using environment variables in EAS and differences in handling them with Expo CLI and EAS CLI.
